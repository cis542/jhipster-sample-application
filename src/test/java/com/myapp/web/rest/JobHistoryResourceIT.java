...
public class JobHistoryResourceIT {
    ...
    public void createJobHistory() throws Exception {
        ...
        restJobHistoryMockMvc
            .perform(
                post("/api/job-histories").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(jobHistory))
            )
    ...
    public void updateNonExistingJobHistory() throws Exception {
        ...
        restJobHistoryMockMvc
            .perform(
                put("/api/job-histories").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(jobHistory))
            )
            .andExpect(status().isBadRequest());
