...
public class DepartmentResourceIT {
    ...
    public void createDepartment() throws Exception {
        ...
        restDepartmentMockMvc
            .perform(
                post("/api/departments").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(department))
            )
    ...
    public void updateNonExistingDepartment() throws Exception {
        ...
        restDepartmentMockMvc
            .perform(put("/api/departments").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(department)))
            .andExpect(status().isBadRequest());
