...
public class CountryResourceIT {
    ...
    public void createCountry() throws Exception {
        ...
        // Create the Country
        restCountryMockMvc
            .perform(post("/api/countries").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(country)))
    ...
    public void getCountry() throws Exception {
        ...
        // Get the country
        restCountryMockMvc
            .perform(get("/api/countries/{id}", country.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void updateCountry() throws Exception {
        ...
        restCountryMockMvc
            .perform(
                put("/api/countries").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedCountry))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingCountry() throws Exception {
        ...
        restCountryMockMvc
            .perform(put("/api/countries").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(country)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteCountry() throws Exception {
        ...
        // Delete the country
        restCountryMockMvc
            .perform(delete("/api/countries/{id}", country.getId()).accept(MediaType.APPLICATION_JSON))
